...
public class GeneroActivity extends AppCompatActivity implements AlbumAdapterRecyclerView.AlbumAdapterInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvCabeceraGenero = findViewById(R.id.tvCabeceraGenero);
        findViewById(R.id.rvGenero);
        ...
        crearRecyclerView(R.id.rvGenero, "");
    ...
    private void crearRecyclerView(Integer idLayout, String tvCategoria) {
        RecyclerView generoRecyclerView = findViewById(idLayout);
        ...
        AlbumAdapterRecyclerView categoriaAdapterRecyclerView = new AlbumAdapterRecyclerView(cargarAlbunes(tvCategoria), R.layout.cardview_album, this, this);

...
public class AlbumAdapterRecyclerView2 extends RecyclerView.Adapter {
    private List<AlbumDeezer> albunDeezer;
    private Integer resources;
    private Activity activity;


    public AlbumAdapterRecyclerView2(List<AlbumDeezer> albunes, int resources, Activity activity) {
